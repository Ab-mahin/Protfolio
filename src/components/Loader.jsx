...
export const AppLoader = ({ isDarkMode = true }) => {
  return (
    <div 
    ...
    >
      <div className="flex flex-col items-center justify-center space-y-6">
        ...
        <div className="flex items-center space-x-3">
          ...
          >
            <span className="font-bold text-lg" style={{ color: isDarkMode ? '#F5F5F5' : '#FFFFFF' }}>AM</span>
          </div>
          <h1 className="text-2xl font-bold" style={{ color: isDarkMode ? '#F5F5F5' : '#000000' }}>Ab Mahin</h1>
        </div>
        ...
        {/* Loading Text */}
        <p className="text-sm opacity-70" style={{ color: isDarkMode ? '#D4D4D4' : '#666666' }}>
          Loading Portfolio...
        </p>
      </div>
    </div>
