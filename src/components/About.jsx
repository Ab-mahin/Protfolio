        ...
        <div className="xl:col-span-3 p-3 md:p-6 relative overflow-hidden" style={{ backgroundColor: isDarkMode ? '#050505' : '#FFFFFF' }}>
              ...
              <Suspense 
                fallback={
                  <div className="w-full h-full flex items-center justify-center">
                    <div className="w-8 h-8 border-2 border-dashed rounded-full animate-spin" style={{ borderColor: isDarkMode ? '#404040' : '#E0E0E0' }}></div>
                  </div>
                }
              >
          ...
          <div className="relative z-0 flex flex-col justify-end min-h-[60px] xs:min-h-[80px] sm:min-h-[120px] md:min-h-[180px] lg:min-h-[220px] xl:min-h-[250px]">
            <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-4">
              <div className="w-6 h-6 md:w-10 md:h-10 rounded-full flex items-center justify-center" style={{ backgroundImage: isDarkMode ? 'linear-gradient(to bottom right, #171717, #404040)' : 'linear-gradient(to bottom right, #E5E5E5, #D1D5DB)' }}>
         ...
         {/* Skills & Technologies */}
         <div className="xl:col-span-3 p-6 relative overflow-visible mt-16 mb-8" style={{ backgroundColor: isDarkMode ? '#000000' : '#FFFFFF' }}>
